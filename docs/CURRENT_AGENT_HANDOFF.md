...
Last verified: 2026-05-09 20:15 UTC
...
app/present/[code]/live/page.tsx  live presentation UI
...
- Extracted game helpers, game panels, dashboard cards, explore cards, study cards, builder workspace, source modals, and study session panels.
...
Latest verified gates on 2026-05-09:
...
1. `app/present/[code]/live/page.tsx` — extract presenter dock/status rail/result visualizers. Higher value, moderate risk.
2. `app/present/[code]/edit/page.tsx` — extract slide list/editor/modal sections. Moderate value.
3. `app/explore/page.tsx` — move remaining filter/sort/header CSS/components. Low risk.
4. `app/study/page.tsx` — move remaining dashboard layout styles into CSS. Low risk.
5. `app/game/[pin]/page.tsx` — only do further logic extraction with live host/player smoke tests. Higher risk.
