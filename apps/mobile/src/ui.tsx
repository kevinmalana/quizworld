...
export const s=StyleSheet.create({
 page:{flex:1,backgroundColor:colors.canvas}, content:{padding:20,gap:18,width:'100%',maxWidth:680,alignSelf:'center',paddingBottom:32},
 heading:{fontFamily:'Bricolage',fontSize:32,lineHeight:37,fontWeight:'800',color:colors.ink,letterSpacing:-0.8},title:{fontFamily:'Bricolage',fontSize:21,lineHeight:28,fontWeight:'700',color:colors.ink},body:{fontSize:17,lineHeight:25,color:colors.ink},muted:{color:colors.muted},meta:{fontSize:14,lineHeight:21,color:colors.muted},
 ...
 button:{minHeight:52,paddingVertical:14,paddingHorizontal:18,borderRadius:16,borderBottomWidth:4,backgroundColor:colors.ink,alignItems:'center',justifyContent:'center',borderWidth:1,borderColor:colors.ink},buttonText:{color:'#fff',fontSize:17,lineHeight:23,fontWeight:'700',textAlign:'center'},secondary:{backgroundColor:'#fff',borderColor:colors.strong},signal:{backgroundColor:colors.signal,borderColor:colors.signal},ink:{color:colors.ink},pressed:{opacity:0.88,transform:[{translateY:2}]},disabled:{opacity:0.5},
