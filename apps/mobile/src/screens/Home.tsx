...
export function Home(){
 ...
 <Button label="Join live game" secondary onPress={()=>nav.navigate('Live')}/>
 ...
 <Meta>{state.sync?`Personal practice · ${state.sync.outbox.length} pending events. Sync and check cloud status in Account. Session history stays on this device.`:'Personal practice · saved on this device, not synced.'}</Meta>
 </Page>;
}
