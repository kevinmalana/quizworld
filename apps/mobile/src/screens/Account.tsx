...
export function Account(){
 ...
 return <Page>
  ...
  <Card>
   ...
   <Body>Checked answers, review questions and your last 100 completed sessions stay here. Cloud sync is not connected.</Body>
   ...
   <Meta>Practice data is unencrypted; do not use this build for private student records. No analytics, ads or uploaded study history. Exports contain practice only, never account credentials.</Meta>
