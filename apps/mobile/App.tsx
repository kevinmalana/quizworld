...
function Main(){return <Tabs.Navigator screenOptions={({route})=>({tabBarIcon:({color})=><Icon name={route.name==='Home'?'Study':route.name} color={color}/>,headerTitle:'quizworld.',headerTitleStyle:{fontWeight:'800',fontSize:24},headerShadowVisible:false,tabBarActiveTintColor:colors.ink,tabBarInactiveTintColor:colors.muted,tabBarLabelStyle:{fontSize:15,fontWeight:'700'},tabBarItemStyle:{paddingVertical:4,minHeight:52},tabBarStyle:{height:72,paddingBottom:8,paddingTop:4}})}><Tabs.Screen name="Home" component={Home} options={{tabBarLabel:'Study',tabBarAccessibilityLabel:'Study'}}/><Tabs.Screen name="Library" component={Library}/><Tabs.Screen name="Account" component={Account}/></Tabs.Navigator>;}
