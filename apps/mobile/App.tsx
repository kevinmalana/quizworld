...
function Main(){return <Tabs.Navigator screenOptions={{headerTitle:'QuizWorld',headerTitleStyle:{fontWeight:'800',fontSize:24},headerShadowVisible:false,tabBarActiveTintColor:colors.ink,tabBarInactiveTintColor:colors.muted,tabBarLabelStyle:{fontSize:15,fontWeight:'700'},tabBarIconStyle:{display:'none'},tabBarItemStyle:{paddingVertical:12,minHeight:52},tabBarStyle:{height:72,paddingBottom:8,paddingTop:4}}}><Tabs.Screen name="Home" component={Home}/><Tabs.Screen name="Library" component={Library}/><Tabs.Screen name="Account" component={Account}/></Tabs.Navigator>;}
