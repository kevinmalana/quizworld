...
import {personalDevice} from './src/personal-device';
...
function AccountPractice(){const auth=useAuth();return <PracticeProvider accountId={auth.user?.id} personalRpc={auth.user?auth.personalRpc:undefined} personalDevice={personalDevice}><Shell/></PracticeProvider>;}
