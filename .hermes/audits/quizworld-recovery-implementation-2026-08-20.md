...
The final exact migration bytes were validated against a disposable PostgreSQL 17 schema modeled from the live audit. Compatibility and lockdown both applied twice transactionally. The validated hashes are `02892facc9567cafe258bbd3be737393af0202d9837f27ae18fc46ea3ebf0fd7` and `a0f3840a6c75a4c250e8216feb327e481c9854834635c54422381a57c20d15bd`. Compatibility probes confirmed the deployed study client remains operational while the new achievement RPC stays unavailable to browser roles; lockdown probes confirmed direct study/achievement writes and legacy RPCs are removed while the trusted achievement RPC becomes available. Additional probes passed for host-only reports, answer-derived XP, canonical taxonomy, immutable presentation runs, Q&A, imported-slide preservation, concurrency-idempotent result ingestion and final grants. The deterministic application gate passed with 70 TypeScript unit tests and 72 Phoenix tests.
