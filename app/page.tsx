...
export default function HomePage() {
  ...
  return <div className="home-root">
    <section className="home-hero container">
      ...
      <div className="home-intro">
        ...
        <div className="home-hero-actions">
          <Link prefetch={false} href="/explore" className="btn btn-primary">Find a quiz</Link>
    ...
    <section className="home-topics container" aria-labelledby="topics-heading">
      ...
      <div className="home-topic-grid">{TOPICS.map(([label,desc,symbol])=><Link prefetch={false} key={label} href={catalogCategoryHref(label)} className="home-category-card"><span className="home-category-symbol" aria-hidden="true">{symbol}</span><span><strong>{label}</strong><small>{desc}</small></span></Link>)}</div>
    </section>
