defmodule QuizworldRealtime.Game do
  ...
  defp ensure_not_eliminated(
         %__MODULE__{game_mode: "survival", eliminated: eliminated},
         player_id
       ) do
